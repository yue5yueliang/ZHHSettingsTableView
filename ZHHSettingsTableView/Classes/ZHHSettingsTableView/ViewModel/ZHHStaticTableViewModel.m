...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.builder respondsToSelector:@selector(configureCell:withViewModel:)]) {
        [self.builder configureCell:cell withViewModel:cellViewModel];
    }
    return cell;
}
